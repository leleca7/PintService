...
export async function createVehicle(formData: FormData) {
  ...
  const vehicles = await sql`
    INSERT INTO veiculos (cliente_id,placa,modelo,cor,seguradora,data_entrada,previsao_saida,status,setor)
    VALUES (${clienteId},${placa},${modelo || null},${cor || null},${seguradora || null},${dataEntrada},${previsaoSaida},${status || null},${setor})
