...
export default async function SettingsPage() {
  ...
  const connections = [
    ...
    { name: 'Dados da oficina', description: 'Horários e endereço usados somente quando estiverem cadastrados como informação oficial.', ready: configured(process.env.OFICINA_HOURS, process.env.OFICINA_ADDRESS), detail: 'horário + endereço confirmados' },
  ];
