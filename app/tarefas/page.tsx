  ...
  return (
    <AppShell active="tarefas" source={data.source}>
      ...
      <section className="metrics compact-metrics">
        ...
        <article><div className="metric-icon">OK</div><div><span>Resolvidas</span><strong>{resolved.length}</strong><small>no histórico carregado</small></div></article>
      </section>
