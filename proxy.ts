...
export const config = {
  matcher: [
    '/((?!api/auth|api/whatsapp|api/instagram/webhook|api/health|api/reputacao/check|api/blinko/summary|auth|site|pint-services-logo.webp|_next/static|_next/image|favicon.ico|manifest.webmanifest).*)',
  ],
};
